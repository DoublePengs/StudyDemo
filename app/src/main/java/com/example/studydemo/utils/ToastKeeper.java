...
public class ToastKeeper {
    ...
    public final class Builder {
        ...
        private boolean mCancelSame = true;
         ...
         * @return
         */
        public Builder setCancelTheSame(boolean cancelSame) {
            mCancelSame = cancelSame;
            return this;
        }
    ...
    private boolean handleSameToast(Builder builder) {
        ...
        boolean mCancelSame = builder.mCancelSame;
        ...
        return mCancelSame && sameBuilder;
    }
    ...
    private View getToastView(Context context, View toastView, CharSequence mMessage) {
        ...
        if (null == toastView) {
            if (mMessage == null) {
                ...
                normalTextView.setTextSize(TypedValue.COMPLEX_UNIT_DIP, 14);
